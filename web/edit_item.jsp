...
<body>
    <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/item/edit/${item.id}" method="post">
        ...
        <form action="${pageContext.request.contextPath}/item/delete/${item.id}" method="get" onsubmit="return confirm('确定要删除这个物品吗？')">
            <button type="submit" class="btn btn-delete">删除物品</button>
        </form>
